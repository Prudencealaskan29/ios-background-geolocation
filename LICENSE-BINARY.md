...
The open-source part of this repository (the bridge/facade sources) is licensed
under the MIT License — see [`LICENSE`](./LICENSE).

This file governs the **closed-source engine binaries** bundled with or pulled
in by this repository. They are NOT covered by the MIT grant: the bridge on its
